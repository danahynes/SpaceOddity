...
# NEXT: check if apod is image before checking same url
#       otherwise log shows pic not changed even if it's a video (rather log video)
# NEXT: make a flowchart of code paths and what text/level to log at each step
# NEXT: use rotating logger
# NEXT: pretty print json in log/console
